...
const S = {
  ...
  left: { flex: 1, background: 'linear-gradient(135deg, #1e1b4b 0%, #312e81 50%, #4c1d95 100%)', display: 'flex', alignItems: 'center', padding: '4rem', position: 'relative', overflow: 'hidden' },
  ...
  tagline: { fontSize: '17px', color: '#a5b4fc', lineHeight: '1.7' },
  ...
  right: { width: '520px', background: '#1e293b', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '3rem', borderLeft: '1px solid #334155' },
  ...
  subtitle: { fontSize: '15px', color: '#64748b', marginBottom: '2.5rem' },
  ...
  input: { padding: '0.75rem 1rem', borderRadius: '10px', border: '1px solid #334155', background: '#0f172a', color: '#f1f5f9', fontSize: '15px', outline: 'none', transition: 'border-color 0.2s', width: '100%', boxSizing: 'border-box' },
