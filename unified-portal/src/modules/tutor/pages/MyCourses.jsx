...
function CourseCoverThumb({ course }) {
  ...
  return (
    <div
      style={{
        ...S.coverPlaceholder,
        background: `linear-gradient(135deg, hsl(${hue},55%,14%) 0%, hsl(${(hue + 40) % 360},45%,9%) 100%)`,
      }}
    >
...
export default function MyCourses() {
  ...
  const togglePublish = async (id, e) => {
    e.stopPropagation();
    try {
      await apiClient.put(`/courses/${id}/publish`);
      fetchCourses();
    } catch {}
  };
  ...
  const deleteCourse = async (id, e) => {
    ...
    if (
      !confirm(
        "Delete this course? Students retain their progress and certificates.",
      )
    )
      return;
    try {
            ...
            return (
              ...
              >
                ...
                <div style={S.actionsRow}>
                  <button
                    onClick={(e) => togglePublish(course._id, e)}
                    style={S.publishBtn}
                  >
