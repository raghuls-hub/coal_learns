...
function ChapterIcon({ type, done, active }) {
  ...
  if (done) return (
    <svg width="13" height="13" viewBox="0 0 24 24" fill="none">
      <path d="M20 6L9 17l-5-5" stroke={col} strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
  if (type === 'video' || type === 'video_upload') return (
    <svg width="12" height="12" viewBox="0 0 24 24" fill="none">
      <polygon points="5,3 19,12 5,21" fill={col}/>
    </svg>
  );
  if (type === 'notes_upload') return (
    <svg width="12" height="12" viewBox="0 0 24 24" fill="none">
      <path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z" stroke={col} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M14 2v6h6" stroke={col} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
  if (type === 'link') return (
    <svg width="12" height="12" viewBox="0 0 24 24" fill="none">
      <path d="M10 13a5 5 0 007.54.54l3-3a5 5 0 00-7.07-7.07l-1.72 1.71" stroke={col} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
      <path d="M14 11a5 5 0 00-7.54-.54l-3 3a5 5 0 007.07 7.07l1.71-1.71" stroke={col} strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
    </svg>
  );
  return (
    <svg width="12" height="12" viewBox="0 0 24 24" fill="none">
                ...
                return (
                  <div key={c._id} onClick={() => handleSelect(mod, c)}
                    ...
                    <span style={S.chapterIcon}>
                      <ChapterIcon type={c.type} done={isDone} active={isActive} />
                    </span>
                    <span style={{ ...S.chapterLabel, color: isActive ? 'white' : isDone ? '#10b981' : 'var(--text-secondary)' }}>
                      {c.title}
                    </span>
                  </div>
                );
                ...
                <div style={S.resourceBox}>
                  ...
                  <a href={resolveUrl(current.data.url)} target="_blank" rel="noopener noreferrer" style={S.resourceLink}>
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" style={{ marginRight: 8 }}>
                      ...
                      <path d="M14 2v6h6M16 13H8M16 17H8M10 9H8" stroke="white" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"/>
                    </svg>
...
const S = {
  ...
  backBtn: { display: 'flex', alignItems: 'center', background: 'none', border: 'none', color: 'var(--text-muted)', cursor: 'pointer', fontSize: 12, fontWeight: 600, padding: '0 0 0.75rem' },
  ...
  chapterIcon: { width: 16, display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
  ...
  doneBtn: { display: 'flex', alignItems: 'center', padding: '0.55rem 1.25rem', background: 'linear-gradient(135deg, #10b981, #059669)', color: 'white', border: 'none', borderRadius: 8, fontSize: 13, fontWeight: 700, cursor: 'pointer', whiteSpace: 'nowrap' },
  doneBtnDone: { display: 'flex', alignItems: 'center', padding: '0.55rem 1.25rem', background: 'rgba(16,185,129,0.1)', color: '#10b981', border: '1px solid rgba(16,185,129,0.25)', borderRadius: 8, fontSize: 13, fontWeight: 700, cursor: 'default', whiteSpace: 'nowrap' },
  ...
  emptyIconWrap: { width: 64, height: 64, borderRadius: '50%', background: 'rgba(255,255,255,0.03)', border: '1px solid var(--border)', display: 'flex', alignItems: 'center', justifyContent: 'center' },
  ...
  aiOnline: { display: 'flex', alignItems: 'center', fontSize: 11, color: '#10b981', fontWeight: 600 },
  ...
  aiSend: { display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '0.65rem 1rem', background: 'linear-gradient(135deg, #6366f1, #22d3ee)', color: 'white', border: 'none', borderRadius: 8, cursor: 'pointer' },
};
