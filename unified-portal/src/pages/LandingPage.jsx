    ...
    <div style={S.page}>
      ...
      <section style={S.hero}>
        <div style={S.heroInner}>
          ...
          <p style={S.heroSub}>
            A unified platform where world-class mentors craft structured
            learning paths and ambitious candidates earn verified credentials.
          </p>
            ...
            {[
              {
                ...
                desc: "Personalized guidance and instant feedback",
              },
              {
                icon: "🎓",
      ...
      <section style={S.portals}>
        <div style={S.portalsInner}>
          ...
          <p style={S.sectionSub}>
            Two specialized portals, one unified experience.
          </p>
          <div style={S.cardsGrid}>
            ...
            <div style={S.card} onClick={() => navigate("/candidate/catalog")}>
              ...
              <p style={S.cardDesc}>
                Browse courses, track your learning journey, and earn
            ...
            <div style={S.card} onClick={() => navigate("/tutor/login")}>
              ...
              <p style={S.cardDesc}>
                Create professional courses, manage your students, and grow your
                teaching impact.
              </p>
              <ul style={S.cardFeatures}>
                {[
...
const S = {
  ...
  featureIcon: { fontSize: 28, flexShrink: 0, minWidth: 40 },
  featureTitle: {
    fontSize: 14,
    fontWeight: 700,
    color: "var(--text-primary)",
